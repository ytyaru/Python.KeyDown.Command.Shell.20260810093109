...
class TerminalContext:
    ...
    def enter_raw_mode(self):
        ...
        # リストの3番目のインデックス (LFLAG) に対して ISIG をオフにする
...
class KeycodeInvestigator:
    ...
    def start_loop(self):
        ...
        # 起動直後から入力を完全に独占し、TTY層への一切のデータ流入（^C含む）を断つ
        self.dev.grab()
    ...
    def get_results(self):
        # 順序を維持したまま、完全に重複を排除したリストを返す
        return list(dict.fromkeys(self.saved_log))
...
def main():
    ...
    try:
        ...
        # TTYを復元し、デバイスの独占権(grab)を確実に安全に解除する
        try:
            dev.ungrab()
        except Exception:
            pass
